...
export class MediaRequest {
  ...
  static async sendNotification(
    ...
    try {
      const mediaType = entity.type === MediaType.MOVIE ? 'Film' : 'Série';
      ...
      switch (type) {
        case Notification.MEDIA_APPROVED:
          event = `${entity.is4k ? '4K ' : ''} Requête de ${mediaType} approuvée`;
          notifyAdmin = false;
          break;
        case Notification.MEDIA_DECLINED:
          event = `${entity.is4k ? '4K ' : ''}Requête de ${mediaType} refusée`;
          notifyAdmin = false;
          break;
        case Notification.MEDIA_PENDING:
          event = `New ${entity.is4k ? '4K ' : ''}Requête de ${mediaType}`;
          break;
        ...
        case Notification.MEDIA_FAILED:
          event = `${entity.is4k ? '4K ' : ''}Requête de ${mediaType} échouée`;
          break;
      }
